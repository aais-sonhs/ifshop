...
urlpatterns = [
    path('receipt-tbl/', views.receipt_tbl, name='receipt_tbl'),
    path('payment-tbl/', views.payment_tbl, name='payment_tbl'),
    path('finance-list-tbl/', views.finance_list_tbl, name='finance_list_tbl'),
    path('cashbook-tbl/', views.cashbook_tbl, name='cashbook_tbl'),
    ...
    path('api/payments/export-excel/', views.export_payments_excel, name='export_payments_excel'),
]
