...
class OrderRiskFlowTests(TestCase):
    ...
    def test_order_page_exposes_copy_action_for_every_order_and_quick_view(self):
        ...
        self.assertContains(response, 'btn-action-group order-action-stack')
        self.assertContains(response, 'order-action-row order-action-row-primary')
        self.assertContains(response, 'order-action-row order-action-row-secondary')
        self.assertContains(response, '#data_tbl .order-action-row')
