...
urlpatterns = [
    ...
    path('purchase-return-tbl/', views.purchase_return_tbl, name='purchase_return_tbl'),
    ...
    path('api/warehouses/inventory/', views.api_get_warehouse_inventory, name='api_get_warehouse_inventory'),
    path('api/warehouses/inventory/save/', views.api_save_warehouse_inventory, name='api_save_warehouse_inventory'),
    ...
    path('api/suppliers/quick-create/', views.api_quick_create_supplier, name='api_quick_create_supplier'),
    ...
    path('api/purchase-returns/', views.api_get_purchase_returns, name='api_get_purchase_returns'),
    path('api/purchase-returns/receipt-detail/', views.api_get_purchase_return_receipt_detail, name='api_get_purchase_return_receipt_detail'),
    path('api/purchase-returns/save/', views.api_save_purchase_return, name='api_save_purchase_return'),
    path('api/purchase-returns/delete/', views.api_delete_purchase_return, name='api_delete_purchase_return'),
