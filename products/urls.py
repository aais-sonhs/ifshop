...
urlpatterns = [
    ...
    path('api/products/sales_history/', views.api_product_sales_history, name='api_product_sales_history'),
    ...
    path('api/products/export_excel/', views.export_products_excel, name='export_products_excel'),
    path('api/goods_receipts/export_excel/', views.export_goods_receipts_excel, name='export_goods_receipts_excel'),
    path('api/stock_transfers/export_excel/', views.export_stock_transfers_excel, name='export_stock_transfers_excel'),
    path('api/stock_checks/export_excel/', views.export_stock_checks_excel, name='export_stock_checks_excel'),
    path('api/purchase_orders/export_excel/', views.export_purchase_orders_excel, name='export_purchase_orders_excel'),
    path('api/suppliers/export_excel/', views.export_suppliers_excel, name='export_suppliers_excel'),
]
