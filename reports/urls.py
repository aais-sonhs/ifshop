...
urlpatterns = [
    ...
    path('setting/daily-email-report/', views.daily_email_report_setting, name='daily_email_report_setting'),
    path('api/daily-email-report/save/', views.api_save_daily_email_report_setting, name='api_save_daily_email_report_setting'),
