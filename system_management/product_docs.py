...
DOCUMENT_UPDATES = [
    ...
    },
    {
        ...
        'items': [
            ...
            'Trong form tạo mới và sửa đơn, mã sản phẩm ở mỗi dòng được làm nổi bật; ngay sau khi chọn sản phẩm, Quy cách được đồng bộ và nằm ngay bên phải mã để tiết kiệm chiều cao, còn bấm vào mã sẽ mở form chỉnh sửa sản phẩm tương ứng trong tab mới.',
...
DETAILED_OPERATION_GUIDES = [
    ...
    },
    {
        ...
        'steps': [
            ...
            'Trong cửa sổ Xem nhanh đơn hàng, mã đơn được làm nổi bật; bấm vào mã để mở form sửa đúng đơn trong tab mới. Đơn đã khóa theo trạng thái chỉ mở ở chế độ xem theo quy định hiện có.',
