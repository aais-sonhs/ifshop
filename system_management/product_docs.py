...
DOCUMENT_UPDATES = [
    ...
    },
    {
        ...
        'items': [
            ...
            'Trong form tạo mới và sửa đơn, mã sản phẩm ở mỗi dòng được làm nổi bật; ngay sau khi chọn sản phẩm, Quy cách được đồng bộ và nằm ngay bên phải mã để tiết kiệm chiều cao. Sản phẩm chưa khai báo Quy cách hiển thị “Quy cách: —”; bấm vào mã để mở form chỉnh sửa sản phẩm tương ứng trong tab mới.',
...
DETAILED_OPERATION_GUIDES = [
    ...
    },
    {
        ...
        'steps': [
            ...
            'Trong cửa sổ Xem nhanh đơn hàng, mã đơn hiển thị bình thường; tại bảng sản phẩm, mã sản phẩm được làm nổi bật và có thể bấm để mở chi tiết trong tab mới. Mỗi dòng còn hiển thị tên sản phẩm, Quy cách và Note nhưng không cho sửa trực tiếp.',
    ...
    },
    {
        ...
        'steps': [
            ...
            'Top SP bán chạy mặc định hiển thị 10 dòng và Top khách hàng mặc định hiển thị 5 dòng; có thể dùng ô chọn trên từng bảng để xem đến 200 dòng.',
            'Phần Chi tiết từng đơn hàng có bộ lọc Từ ngày - Đến ngày riêng, mặc định từ ngày đầu tháng đến ngày cuối tháng hiện tại; bảng chỉ dựng dữ liệu khi mở để tránh làm trang nặng.',
