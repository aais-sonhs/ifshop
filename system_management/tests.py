...
class SystemManagementScopeTests(TestCase):
    ...
    def test_product_guide_is_available_for_owner_and_superadmin(self):
        ...
        self.assertContains(response, 'Đơn hoàn thành nhưng còn nợ')
        self.assertContains(response, 'Lợi nhuận không chờ thu hết nợ')
        ...
        self.assertContains(response, 'Đơn hoàn thành vẫn có công nợ')
