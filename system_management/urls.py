...
urlpatterns = [
    ...
    path('classification-tbl/', views.classification_tbl, name='classification_tbl'),
    path('expense-classification-tbl/', views.classification_tbl, name='expense_classification_tbl'),
